    ...
    return(
        <Pressable style={[base.align_stretch, styles.wrapper]} onPressIn={onPressIn} onPressOut={onPressOut}>
            <View style={[base.align_stretch, base.position_relative]}>
                ...
                <Animated.View style={[base.position_absolute, base.flex_row, base.align_center, base.justify_center, base.w_100, base.h_100, styles.container, {backgroundColor: isDisabled||isLoading? colors.__x_grey:colors.__x_white, borderColor: colors.__x_black, transform:[{translateX: displacement}, {translateY: displacement}]}]}>
