...
const TieIllustration = require("../../assets/images/tie.png");
                ...
                <View style={[base.position_relative, base.align_center, base.justify_center, styles.mainWrapperWidth, {height: windowSize?.height}]}>
                    ...
                    <View style={[styles.wrapper, base.position_relative]}>
                        ...
                        <View style={[styles.modalContainer, base.p_8, base.w_100, base.align_center, { backgroundColor: colors.__x_white, borderColor: colors.__x_black }]}>
                            <Image style={[styles.illustration]} source={TieIllustration}/>
                            <TextTag type="textM" style={[base.sans_800, base.pb_3, base.pt_6, { color: colors.__x_black }]}>Unbeatable stalemate!</TextTag>
                            <TextTag type="textM" style={[base.sans_400, base.pb_8, { color: colors.__x_black }]}>Its a deadlock! Those were some incredible tic-tac-toe skills. Step up your game for the next match.</TextTag>
